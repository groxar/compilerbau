...
extern void fatal_compiler_error (compiler_error_t err, int errno, const char *msg, ...);
#define FATAL_COMPILER_ERROR(err,errno,...) fatal_compiler_error(err, errno, __VA_ARGS__);
