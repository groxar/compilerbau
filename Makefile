...
# DHBW Compiler                               #
###############################################
DHBWCC_OBJECTS = $(addprefix $(OBJDIR)/, scanner.o parser.o main.o diag.o resource_manager.o symboltable.o ir_generator.o typcheck.o as_generator.o)
...
$(OBJDIR)/as_generator.o: $(SRCDIR)/as_generator.c 
	$(CC) $(CFLAGS) -c $< -o $@
